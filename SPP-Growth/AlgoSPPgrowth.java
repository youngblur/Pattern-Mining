...
/**
 * This is an implementation of the PFTIGrowth algorithm based on FP-growth
 *
...
public class AlgoSPPgrowth {
    ...
    private int lastTID = -1; // largest TID in the database
    private int itemsetCount; // number of freq. itemsets found

//    // for test
//    ArrayList<Integer> testRes = new ArrayList<>();
     ...
     * Constructor
     */
    public AlgoSPPgrowth(int maxPer, int minSup, int maxLa, boolean self_increment) {
        this.minSup = minSup;
        this.maxPer = maxPer;
...
//        System.out.println("total:"+len);
        ...
        if(tree.headerList.size() > 0) {
            ...
            // recursively generate the itemsets that have periodic frequent time-interval  using the pfti-tree
